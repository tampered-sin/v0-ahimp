...
def benchmark_models():
    ...
    try:
        ...
        try:
            ...
            baseline_r2 = baseline_results.get("xgb", {}).get("r2")
            if baseline_r2 is None:
                baseline_r2 = baseline_results.get("xgb_r2")
        ...
        results = {
            ...
            "baseline": {
                "model": "XGBoost",
                "training_r2": round(float(baseline_r2), 4) if baseline_r2 is not None else None,
                "training_time_sec": round(baseline_time, 4) if baseline_time is not None else None,
            } if baseline_r2 is not None else None,
            ...
            "comparison_to_baseline": {
                "r2_improvement": round(catboost_r2 - float(baseline_r2), 4) if baseline_r2 is not None else None,
                "catboost_better": bool(catboost_r2 > baseline_r2) if baseline_r2 is not None else None,
            } if baseline_r2 is not None else None,
